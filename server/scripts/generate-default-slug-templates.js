...
async function main() {
  ...
  for (const r of dataRows) {
    ...
    templates.push({
      ...
      voidsFireClash: toBool(r[col("Voids Fire Clash")]),
      clearsFireTerrain: toBool(r[col("Clears Fire Terrain")]),
      causesDisarm: toBool(r[col("Causes Disarm")]),
      disarmZone: toBool(r[col("Disarm Zone")]),
      mindScramble: toBool(r[col("Mind Scramble")]),
      swapsPosition: toBool(r[col("Swaps Position")]),
      frictionShift: toBool(r[col("Friction Shift")]),
      crosswindZone: toBool(r[col("Crosswind Zone")]),
      skipsReload: toBool(r[col("Skips Reload")]),
      emotionSurge: toBool(r[col("Emotion Surge")]),
